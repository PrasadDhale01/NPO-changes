        ...
        <div class="thumbnail campaign-tile-width">
            ...
            <div class="campaign-tile-content">
                <div class="campaign-title-padding">
                    <g:if test="${iscampaignAdmin}">
                        <a href="javascript:void(0)" onclick="submitCampaignShowForm('manage','${campaign.id}','${username }');" id="manage:${campaign.id}">
                            ${campaign.title.toUpperCase()}
                        </a>
                    </g:if>
                    <g:else>
                        <a href="javascript:void(0)" onclick="submitCampaignShowForm('show','${campaign.id}','${username }');" id="show:${campaign.id}" >
                            ${campaign.title.toUpperCase()}
                        </a>
                    </g:else>
                </div>
