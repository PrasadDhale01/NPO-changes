...
<html>
    <head>
        <title>Crowdera- InviteMembers</title>
                    ...
                    <div class="col-sm-12" id="inviteTeamMember">
                        <g:form controller="project" action="inviteTeamMember" id="${project.id}" method="POST" class="inviteTeamMember">
                            ...
                            <div class="form-group">
                                <label>Name</label><input type="text" class="form-control all-place" name="username" value="${user.firstName +' '+ user.lastName}" placeholder="Name" />
                            </div>
                            <div class="form-group">
                                          ...
                                          <div class="col-sm-8">
                                              <div class="input-group">
                                                  <span class="input-group-btn"> 
                                                      <span class="btn btn-info btn-file"> Browse<input type="file" name="filecsv" id="csvfile" accept=".csv" class="filecsv"> </span>
                                                  </span> 
