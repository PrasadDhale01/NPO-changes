<div class="container how-it-work-container">
   <div class="row">
    <h1 class="text-center headingtext1">Why Crowdera</h1>
   </div> 
</div>
<div class="container whycrowderatemplate how-it-work-container">
	<div class="row hidden-sm hidden-xs">
		...
		<div class="col-md-6">
			...
			<div class="col-md-12 whycrowderadiv whycrowderacol-md whycdradivpadding">
				<div class="col-md-2">
			...
			<div class="col-md-12 whycrowderadiv whycrowderacol-md whycdradivpadding8">
				<div class="col-md-2">
	...
	<div class="hidden-md hidden-lg whycrowderacol-sm">
	    <div class="col-sm-6 col-xs-12">
			<div class="col-sm-12 col-xs-12 whycrowderadiv whycrowderadiv-sm">
			    <div class="whycrowderadiv-sm-padding">
			...
			<div class="col-sm-12 col-xs-12 whycdradivpadding2 whycrowderadiv whycrowderadiv-sm">
			    <div class="whycrowderadiv-sm-padding">
				    <img src="//s3.amazonaws.com/crowdera/assets/flexible-funding-icon.png" alt="Flexible-Deadline">
                </div>
                <div class="whycrowderadiv-sm-padding">
                    <h4 class="pull-left subheadingtext">Flexible Funding</h4>
				    <div class="clear"></div>
			...
			<div class="col-sm-12 col-xs-12 whycdradivpadding3 whycrowderadiv whycrowderadiv-sm">
			    <div class="whycrowderadiv-sm-padding">
				    <img src="//s3.amazonaws.com/crowdera/assets/flexible-deadline-icon.png" alt="Flexible-Funding">
				</div>
				<div class="whycrowderadiv-sm-padding">
                    <h4 class="pull-left subheadingtext">Flexible Deadline</h4>
				    <div class="clear"></div>
			...
			<div class="col-sm-12 col-xs-12 whycdradivpadding4 whycrowderadiv whycrowderadiv-sm">
			    <div class="whycrowderadiv-sm-padding">
				    <img src="//s3.amazonaws.com/crowdera/assets/multiple-secure-payment-gateways-icon.png" alt="Free-Crowdfunding">
				</div>
				<div class="whycrowderadiv-sm-padding">
		...
		<div class="col-sm-6 col-xs-12">
			...
			<div class="col-sm-12 col-xs-12 whycrowderadiv whycdradivpadding6 whycrowderadiv-sm">
				<div class="whycrowderadiv-sm-padding">
				    <img src="//s3.amazonaws.com/crowdera/assets/mobile-friendly-funding-icon.png" alt="Mobile-Friendly-Funding-Page">
				</div>
				<div class="whycrowderadiv-sm-padding">
			...
			<div class="col-sm-12 col-xs-12 whycdradivpadding7 whycrowderadiv whycrowderadiv-sm">
			    <div class="whycrowderadiv-sm-padding">
				    <img src="//s3.amazonaws.com/crowdera/assets/instant-fundraising-icon.png" alt="Multiple-Secure-Payment-Gateways">
				</div>
				<div class="whycrowderadiv-sm-padding">
			...
			<div class="col-sm-12 col-xs-12 whycdradivpadding8 whycrowderadiv whycrowderadiv-sm">
				<div class="whycrowderadiv-sm-padding">
				    <img src="//s3.amazonaws.com/crowdera/assets/free-crowdfunding-icon.png" alt="Teams-to-Multiply-Results">
				</div>
				<div class="whycrowderadiv-sm-padding">
