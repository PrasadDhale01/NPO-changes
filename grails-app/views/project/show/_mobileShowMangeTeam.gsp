...
<g:if test="${!totalteams.isEmpty()}">
	<ul class="nav nav-pills">
		<li data-toggle="tab" class="active show-team col-md-4 col-sm-4 col-xs-4 button-team-show sh-mobile-teamcount">
		    ...
		    <g:if test="${(currentFundraiser == currentUser || isCrUserCampBenOrAdmin) && project.validated}">
                <li data-toggle="tab" class="col-md-4 col-sm-4 col-xs-4 show-team-button button-team-show sh-teamsactive">
    ...
    <div class="tab-content">
        <div class="tab-pane active col-md-12 col-sm-12 col-xs-12" id="team">
            <div class="teamList" id="teamListmobile">
                <g:render template="show/teamgridmobile"/>
            </div>
        </div>
    </div>
