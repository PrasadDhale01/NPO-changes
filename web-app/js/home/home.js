...
$('.hm-js-hover2').hover(function(){
    $('.hm-media-2').attr('src',"//s3.amazonaws.com/crowdera/assets/canada-govt-colour-media.png");
 	}).mouseleave(function(){
    $('.hm-media-2').attr('src',"//s3.amazonaws.com/crowdera/assets/canada-govt-white-media.png");
});
