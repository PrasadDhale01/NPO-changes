    ...
    <tr class="active">
		...
		<td>
		    <g:form action="delete" controller="login" id="${users.id}" method="post" >
		        <button class="btn btn-danger login-adminviews" name="_action_delete" value="Delete" onclick="return confirm(&#39;Are you sure you want to Delete this request?&#39;);"><i class="fa fa-trash-o"></i> Discard
	            </button>
            </g:form>
		</td>
    </tr>
