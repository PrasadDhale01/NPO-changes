<div class="container marketing">
    ...
    <div class="row">
        <div class="col-lg-4">
            <img class="img-circle" src="https://s3.amazonaws.com/crowdera/assets/icon-5.png" alt="Create a Fundraiser"/>
        ...
        <div class="col-lg-4">
            <img class="img-circle" src="https://s3.amazonaws.com/crowdera/assets/icon-6.png" alt="Share your Campaign"/>
        ...
        <div class="col-lg-4">
            <img class="img-circle" src="https://s3.amazonaws.com/crowdera/assets/icon-7.png" alt="Update your Campaign"/>
