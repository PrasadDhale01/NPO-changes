  				...
  				<div class="question-list">
  					<g:form action="saveFeedback" controller="user" method="POST" class="feedback-form">
	  					...
	  					<div class="form-group question">
	  						...
	  						<div class="answer">
	  							<input type="text" placeholder="" class="form-control input-lg" name="answer_1"> 
	  						</div>
	  					</div>
	  					<div class="form-group question">
	  						...
	  						<div class="form-group secondQOptOne">
		  						...
		  						<div class="answer">
		  							<input type="text" placeholder="" class="form-control input-lg" name="answer_2_y1"> 
		  						</div>
		  						<br>
		  						<span>b)&nbsp;What did you like the best about those platforms?</span>
		  						<div class="answer">
		  							<input type="text" placeholder="" class="form-control input-lg" name="answer_2_y2"> 
		  						</div>
	  						</div>
	  						<div class="form-group secondQOptTwo">
		  						...
		  						<div class="answer">
		  							<div class="">
										<input type="text" placeholder="" class="form-control input-lg" name="answer_2_n">
									</div> 
		  						</div>
	  						</div>
	  					</div>
	  					<div class="form-group question">
	  						...
	  						<div class="answer">
	  							<input type="text" placeholder="" class="form-control input-lg" name="answer_3"> 
	  						</div>
	  					</div>
	  					<div class="form-group question">
	  						...
	  						<div class="form-group question_4_opt_yes">
		  						...
		  						<div class="answer">
		  							<input type="text" placeholder="" class="form-control input-lg" name="answer_4_y"> 
		  						</div>
	  						</div>
	  						<div class="form-group question_4_opt_no">
	  							<span>a)&nbsp;Is there a reason why you didn't use the Team feature?</span>
		  						<div class="answer">
		  							<input type="text" placeholder="" class="form-control input-lg" name="answer_4_n">  
		  						</div>
	  						</div>
	  					</div>
	  					<div class="form-group question">
	  						...
	  						<div class="answer">
	  							<input type="text" placeholder="" class="form-control input-lg" name="answer_5">  
	  						</div>
	  					</div>
	  					<div class="form-group question">
