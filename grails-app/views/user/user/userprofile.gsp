                    ...
                    <div class="col-lg-3 col-sm-3 bg-color-white">
                        <g:if test="${user.userImageUrl}">
                            <div id="userImage" class="TW-userprofile-img">
                                <a id="userprofileImage"><img src="${user.userImageUrl}" alt="avatar" class="center-usrprfl-img"></a>
                                <div class="userprofile-caption center-usrprfl-img"><p>${username}</p> </div>
                            </div>
                        </g:if>
                        <g:else>
                            <div id="userDefaultImage" class="TW-userprofile-img">
                                <a id="userprofileImage-dflt"><img alt="Default image" src="https://s3.amazonaws.com/crowdera/assets/profile_image.jpg" class="center-usrprfl-img"></a>
                                <div class="userprofile-caption center-usrprfl-img"><p>${username}</p></div>
                            </div>
                       </g:else>
                   </div>
                           ...
                           <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                               <div class="panel panel-info userprofile-panel-border">
                                   <div class="panel-heading TW-usrprfl-heading">
                                    ...
                                    <div class="panel-footer TW-userprofile-panel-text-Size">Total raised</div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                                <div class="panel panel-info userprofile-panel-border">
                                   ...
                                   <div class="panel-footer TW-userprofile-panel-text-Size">Total contributions</div>
                               </div>
                           </div>
                          <div class="col-lg-4 col-md-4 col-sm-4 col-xs-12">
                              <div class="panel panel-info userprofile-panel-border">
                                  ...
                                  <div class="panel-footer TW-userprofile-panel-text-Size">Supported campaigns</div>
                              </div>
                          </div>
                      </div>
                  </div>
                  ...
                  <div class="col-lg-12">
                      <ul class="nav nav-tabs nav-justified" id="TW-usrPrfl-ul">
                          <li class="TW-userTimeline active TW-usrPrfl-li">
                              <a data-toggle="tab" href="#timeline"><i class="icon-home"></i>Timeline</a>
                          </li>
                          <li class="TW-userCamapaign TW-usrPrfl-li">
                              <a data-toggle="tab" href="#campaigns"><i class="icon-envelope"></i>Campaign Supported</a>
                          </li>
                          <li class="TW-userContribution TW-usrPrfl-li">
                              <a data-toggle="tab" href="#contribution"><i class="icon-envelope"></i>Contribution</a>
                          </li>
                      </ul>
                      <section class="panel">
