	...
	<div class="form-signin">
	    <g:if test="${imageUrl != null}">
	        <div class="profileavatar" class="blacknwhite">
	            ...
	            <div class="deleteavatar">
	               <g:link action="deleteavatar" controller="user" id="${user.id}"><img alt="Delete" onclick="return confirm(&#39;Are you sure you want to deleted this avatar?&#39;);" src="https://s3.amazonaws.com/crowdera/assets/delete.ico"/></g:link>
	            </div>
	        </div>
	    ...
	    <g:else>
	        <div class="uploadimage" class="blacknwhite">
	            <img src="https://s3.amazonaws.com/crowdera/assets/profile_image.jpg" class="profileimage" alt="Upload Photo"/>
	        </div>
