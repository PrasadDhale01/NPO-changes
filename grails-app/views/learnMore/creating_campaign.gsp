<%@page import="crowdera.LearnMore"%>
<html>
<head>
    <meta name="layout" content="main" />
    <title>Learn More- Creating Campaign</title>
</head>
<body>
<div class="feducontent learnBg-color">
 <div class="container learnContainer">
 <div class="row footer-panel-group">
            <h1><strong class="faq-subheading"><a href="${resource(dir: '/Learning-Center')}">Learn More </a>> Creating a campaign</strong></h1>
              <hr>
        
              <div class="pull-left hidden-xs">
<ul id="side-menu" class="greyColor" style="height: 850px;">
<li>
   <a class="active whitefont" href="/Creating-Campaign"> Create Campaign </a>
</li>
<li>
   <a class="active whitefont" href="/Perks"> Perk</a>
</li>
<li>
   <a class="active whitefont" href="/Managing-Campaign"> Manage Campaign</a>
</li>
<li>
   <a class="active whitefont" href="/Contributor"> Contributor</a>
</li>
</ul>
</div>
<div class="pull-right col-lg-8 paneWidth"  id="accordion">
                    ...
                    <div id="collapseProTen" class="panel-collapse collapse faq-panel-height">
                        <div class="panel-body">
                                <ul>
                                    ...
                                    <br>
                                        <img style="width:100%;" class="img-responsive" src="//s3.amazonaws.com/crowdera/assets/7e8166e4-2dd8-4012-9652-4e2f49748382.png" alt="product-faq-header">
                                    <br>
                                    </li>
                                    ...
                                    <li class="noBullet articlePic">
                                    <p>If you don’t want to use social media to sign in, simply use your email, 
                                        desired password and provide us with your First and Last Name. 
                                    <p>
                                    <p>
                                        <img style="width:100%;" class="img-responsive" src="//s3.amazonaws.com/crowdera/assets/492b7891-d4ff-4918-a6d5-c4dab91ec440.png" alt="product-faq-signup-b">
                                    </p>
                                    </li>
                                    <li><p>To edit or add more information to your profile sign into your Crowdera account</p></li>
                ...
                <div class="panel panel-default">
                    ...
                    <div id="collapseProTenThree" class="panel-collapse collapse faq-panel-height">
                        <div class="panel-body articlePic">
                    ...
                    <div id="collapseSeven" class="panel-collapse collapse faq-panel-height">
                        <div class="panel-body articlePic">
                            ...
                            <ul>
                                ...
                                <li class="noBullet articlePic">
                                <br>
                                    <img class="img-responsive" src= "//s3.amazonaws.com/crowdera/assets/ca898caa-d0de-4c2f-aa65-b986265635d7.png" alt="product-faq-planis"> 
                                <br>
                                </li>
                                <li>Complete the remaining information for your campaign</li>
                                <li>Your draft will be autosaved and can be access via your Dashboard</li> 
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseTwentyOne">How do I add a video to my campaign? Can I add more than one video?</a>
                        </h4>
                    </div>
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapseProTenOne">How can I add images to the campaign?</a>
                        </h4>
                    </div>
