...
<div class="feducontent">
	<div class="container">
		<h1><img class="img-circle" src="https://s3.amazonaws.com/crowdera/assets/icon-edit.png" alt="Edit Campaign"/> Edit Campaign</h1>
                                ...
                                <div id="icondiv" class="pr-icon-thumbnail-div col-sm-4">
                                        <g:if test="${project.organizationIconUrl}">
                                            ...
                                            <div class="deleteicon orgicon-css-styles">
                                                ...
                                                src="https://s3.amazonaws.com/crowdera/assets/delete.ico" id="logoDelete"/>
                                            </div>
                                        </g:if>
                                        <g:else>
					    ...
					    <g:if test="${email1}">
				            <div class="deleteIconAbove">
                                                <img alt="admin delete" onClick="deleteAdmin(this,'${project.id}', 'email1', '${email1}');"
                                                    src="https://s3.amazonaws.com/crowdera/assets/delete.ico" id="logoDelete1"/>
                                            </div>
                                        </g:if>
                                   </div>
				</g:if>
	                                ...
	                                <g:if test="${email2}">
	                                    <div class="deleteIconAbove">
                                                <img alt="admin delete" onClick="deleteAdmin(this,'${project.id}', 'email2', '${email2}');"
                                                    src="https://s3.amazonaws.com/crowdera/assets/delete.ico" id="logoDelete2"/>
                                            </div>
                                        </g:if>
	                            </div>
	                        </g:if>
	                                 ...
	                                 <g:if test="${email3}">
	                                    <div class="deleteIconAbove">
                                                <img alt="admin delete" onClick="deleteAdmin(this,'${project.id}', 'email3' ,'${email3}');"
                                                    src="https://s3.amazonaws.com/crowdera/assets/delete.ico" id="logoDelete3"/>
                                            </div>
                                        </g:if>
                                    </div>
	                        </g:if>
