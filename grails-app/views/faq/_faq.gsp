<div class="container">
	<div class="crowderaFaq">
		<h2>FAQs</h2>
		<h3>General FAQs</h3>
		<h4>What is Crowdera?</h4>
		...
		<h4>Who are the people that fund my campaign?</h4>
		...
		<h4>Why will someone fund my campaign? Why will people contribute
			towards my campaign?</h4>
		...
		<h3>Campaigns FAQs</h3>

		<h4>What do I need to create a campaign?</h4>
		<ul>
		...
		<h4>Will Crowdera assist in creating the campaign?</h4>
		...
		<h4>How much does Crowdera charge?</h4>
		...
		<h4>Why do I need to build a strong social network and share my
			campaign?</h4>
		...
		<h4>Do I get to see my contributors and how much they
			contributed?</h4>
		...
		<h4>Can I offer rewards?</h4>
		<p class="text-justify">Yes you can! You can create your own
			rewards as well.</p>

		<h4>Are rewards mandatory?</h4>
		<p class="text-justify">No, rewards are not mandatory.</p>

		<h4>Can I edit my campaign after I submit it?</h4>
		...
		<h4>What if I don’t meet my fundraising goal? Do I still get the
			funds?</h4>
		...
		<h4>What if I raise more than my goal?</h4>
		<p class="text-justify">You keep it!</p>

		<h4>Why don’t I see my campaign on Crowdera after submitting?</h4>
		<p class="text-justify">After submitting, the campaign go through
			an approval process. Once the campaign is approved it goes live.</p>

		<h4>What benefits does Crowdera offer?</h4>
		<ul type="decimal">
			<li>Fundraising is FREE! Crowdera does not charge any fee, it’s
		...
		<h4>What is the minimum amount that I can raise through Crowdera?</h4>
		<p class="text-justify">There is no minimum funding goal to be on
			the platform.</p>

		<h4>What is the maximum amount that I can raise through Crowdera?</h4>
		<p class="text-justify">
		...
		<p class="text-justify">The beneficiary / campaign creator is
			responsible for shipping the rewards.</p>

		<h3>Contribution FAQs</h3>

		<h4>How much of the funds raised reach the creator?</h4>
		...
		<h4>Do I need to sign up to contribute?</h4>
		...
		<h4>What payment method do you provide?</h4>
		...
		<h4>I do not wish to use online methods of payment. How do I
			offer offline contributions?</h4>
		<p class="text-justify">
...
<%--			creating the campaign?</h4>--%>
		<h4>Is your site secure for online credit / debit card
			transactions?</h4>
		<p class="text-justify">
		...
		<h4>I got an error while making an online contribution. How will
			I know whether the transaction was successful?</h4>
		...
		<h4>Why should I contribute through Crowdera instead of
			contributing directly?</h4>
		<ul>
			...
			<li>Many organization do not have the option of contributing
				online.</li>
		</ul>

		<h4>What is the minimum amount for a fund?</h4>
		<p class="text-justify">You can contribute a minimum of $1.</p>

		<h4>How can I cancel my contribution?</h4>
		...
		<h4>How do I know my funds have reached the beneficiary?</h4>
		...
		<h4>How do I know that my contribution was utilized for the
			purpose?</h4>
...
<%--		<h4>I am not from India; how can I contribute to a campaign?</h4>--%>
<%--		<p class="text-justify">Unfortunately our current platform only--%>
<%--			accepts Indian cards. Don’t get disheartened, you can contribute to--%>
<%--			campaigns on our US website on www.crowdera.co .</p>--%>

		<h4>I am an International contributor. Can I still contribute to
			the cause?</h4>
		...
		<h4>How safe is it to login using Facebook?</h4>
		<p class="text-justify">
			Please refer to the Personal Information section on our <a
				href="${resource(dir: '/privacypolicy')}">Privacy Policy</a> page.
		</p>

		<h4>Is it possible to make anonymous contribution? Can I do so
			after being logged in?</h4>
		<p class="text-justify">Yes it is. You can make an anonymous
		...
		<h4>Does my contribution amount show on Crowdera?</h4>
		...
		<h4>Do I get tax deductions on my contributions?</h4>
