    ...
    <div class="carousel-inner">
        <div class="item active">
            <g:if test="${userService.isLoggedIn()}">
                <img class="hidden-xs" src="//s3.amazonaws.com/crowdera/assets/collage.jpg" alt="Slider-1"/>
                <img class="visible-xs" src="//s3.amazonaws.com/crowdera/assets/collageMobile.jpg" alt="Mobile Slider-1"/>
...
<%--                </g:else>--%>
            ...
            <g:else>
            <img class="hidden-xs or-css" src="//s3.amazonaws.com/crowdera/assets/collage.jpg" alt="Slider-1"/>
            <img class="visible-xs" src="//s3.amazonaws.com/crowdera/assets/collageMobile.jpg" alt="Mobile Slider-1"/>
            <div class="carousel-caption">
                <div class="fbButton">
        ...
        <div class="item ">
            <img class="hidden-xs" src="//s3.amazonaws.com/crowdera/assets/girlWithComputer.jpg" alt="Girl Computer Slider"/>
            <img class="visible-xs" src="//s3.amazonaws.com/crowdera/assets/slide2Mobile.jpg" alt="Girl Computer Slider Mobile"/>
        </div>
        <div class="item">
            <img class="hidden-xs" src="//s3.amazonaws.com/crowdera/assets/kidsRunning.jpg" alt="kids Running Slider"/>
            <img class="visible-xs" src="//s3.amazonaws.com/crowdera/assets/slide3Mobile.jpg" alt="kids Running Slider Mobile"/>
        </div>
    </div>
