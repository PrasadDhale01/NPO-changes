...
<body>
    ...
    <g:hiddenField name="wepayEmailId" value="${project.wepayEmail}" id="wepayEmailId"/>
    ...
    <div class="bg-color col-sm-12 col-xs-12 cr-top-space">
                    ...
                    <div class="col-sm-3 cr2-width-dropdown2">
                        <div class="cr-dropdown-alignment font-list">
                            <g:if test="${project.beneficiary.country && project.beneficiary.country != 'null'}">
                                <g:select style="width:0px !important;" class="selectpicker cr-drops cr-drop-color cr-start-dropdown-country cr-all-mobile-dropdown" id="country" name="${FORMCONSTANTS.COUNTRY}" from="${country}" value="${selectedCountry}" optionKey="key" optionValue="value" />
                            </g:if>
                            <g:else>
                   ...
                   <div class="col-sm-3 cr2-width-dropdown3  cr2-width-city">
                    ...
                    <div class="col-sm-3 cr2-width-dropdown4">
                        <div class="font-list">
                            ...
                            <g:elseif test="${project.wepayEmail}">
                                <g:select class="selectpicker cr-start-dropdown-payment cr-drops cr-drop-color cr-all-mobile-dropdown" name="${FORMCONSTANTS.PAYMENT}" from="${payOpts}" id="paymentOpt" value="WEPAY" optionKey="key" optionValue="value" />
                            </g:elseif>
                    ...
                    <div class="col-sm-3 cr2-width-dropdown5">
                        <div class="cr-dropdown-alignment font-list">
                            <g:if test="${'in'.equalsIgnoreCase(country_code)}">
                                ...
                                <g:else>
                                    <g:select style="width:0px !important;" class="selectpicker cr-drops cr-drop-color cr-all-mobile-dropdown recipient cr2-funds-drop" name="fundsRecievedBy" from="${nonIndprofit}" optionKey="key" optionValue="value" noSelection="['null':'Recipient of fund']"/>
                                </g:else>
                            </g:if>
                            <g:else>
                                <g:if test="${project.fundsRecievedBy}">
                                    <g:select style="width:0px !important;" class="selectpicker cr-drops cr-drop-color cr-all-mobile-dropdown recipient cr2-funds-drop" name="fundsRecievedBy" from="${nonProfit}" value="${project.fundsRecievedBy}" optionKey="key" optionValue="value"/>
                                </g:if>
                                <g:else>
                                    <g:select style="width:0px !important;" class="selectpicker cr-drops cr-drop-color cr-all-mobile-dropdown recipient cr2-funds-drop" name="fundsRecievedBy" from="${nonProfit}" optionKey="key" optionValue="value" noSelection="['null':'Recipient of fund']"/>
                                </g:else>
                            </g:else>
                        </div>
                    </div>
                                ...
                                <div class="spend-matrix-template" id="spend-matrix-template${spend.numberAvailable}">
                                    ...
                                    <div class="col-sm-amt col-sm-12">
                                        ...
                                        <div class="col-sm-5 col-xs-7 col-input-for form-group">
                                            <input type="text" class="form-control form-control-input-for spendCause" maxlength="48" id="spendCause${spend.numberAvailable}" name="spendCause${spend.numberAvailable}" value="${spend.cause}">
                                        </div>&nbsp;&nbsp;
        ...
        <g:if test="${currentEnv == 'development' || currentEnv == 'test' || currentEnv == 'testIndia'}">
                            ...
                            <div class="form-group">
                                <div class="col-sm-12">
                                    <g:if test="${project.beneficiary.telephone}">
                                        <input type="tel" id="telephone" class="form-control form-control-no-border cr-placeholder cr-chrome-place text-color cr-marg-mobile personalTelephone" maxlength="16" name="${FORMCONSTANTS.TELEPHONE}" placeholder="Phone" value="${project.beneficiary.telephone}">
                                    </g:if>
                                    <g:else>
                                        <input type="tel" id="telephone" class="form-control form-control-no-border cr-placeholder cr-chrome-place text-color cr-marg-mobile personalTelephone"  maxlength="16" name="${FORMCONSTANTS.TELEPHONE}" placeholder="Phone">
                                    </g:else>
                                </div>
                            </div>
                        </div>
            ...
            <g:else>
            	<div class="col-sm-12" id="wepayDiv">
                    <div class="panel panel-body cr-panel-body-spend-matrix cr-panel-body">
                        
                        <div class="col-sm-6">
                            <div class="form-group">
                                <g:if test="${project.wepayFirstName}">
                                    <input id="wepayFirstName" type="text" maxlength="64" class="form-control form-control-no-border cr-placeholder cr-chrome-place" value="${project.wepayFirstName}" name="wepayFirstName" placeholder="Wepay User FirstName">
                                </g:if>
                                <g:else>
                                    <input id="wepayFirstName" type="text" maxlength="64" class="form-control form-control-no-border cr-placeholder cr-chrome-place" name="wepayFirstName" placeholder="Wepay User FirstName">
                                </g:else>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6">
                            <div class="form-group">
                                <g:if test="${project.wepayEmail}">
                                    <input id="wepayEmail" type="email" maxlength="64" class="form-control form-control-no-border cr-placeholder cr-chrome-place" value="${project.wepayEmail}" name="wepayEmail" placeholder="Wepay email address">
                                </g:if>
                                <g:else>
                                    <input id="wepayEmail" type="email" maxlength="64" class="form-control form-control-no-border cr-placeholder cr-chrome-place" name="wepayEmail" placeholder="Wepay email address">
                                </g:else>
                                
                                <g:hiddenField name="wepayEmailAck" value="" id="wepayEmailAck"/>
                            </div>
                        </div>
...
<%--                                <label class="col-sm-4 control-label">FirstGiving</label>--%>
                ...
                <g:render template="create/taxreceipt"></g:render>
