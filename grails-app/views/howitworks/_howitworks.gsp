<div class="container">
	...
	<div>
		<iframe width="100%" height="500"
			src="//www.youtube.com/embed/W_lME-8P-Dk" frameborder="0"
	...
	<div class="panel panel-default">
		...
		<div class="panel-body"><p class="lead">ASK, RECEIVE & ACHIEVE</p>
            Create your campaign, decide how much you want to raise and confirm you are you. If you or someone you know wants to learn, you can create a profile and connect with a FEDU representative to complete the qualification process, OR you can choose to contribute towards an existing student.</div>
	</div>
	<div class="panel panel-default">
		<div class="panel-heading">
	...
	<div class="panel panel-default">
		...
		<div class="panel-body"><p class="lead">REWARDS, SHARE & INFLUENCE</p>
            As an educational ally, your contribution affects more than one student and you’re contributing to a larger effort. You are "Enabling Education for All”. FEDU is on a mission to globally confront the social inequality within education. And with your shared belief in the power of education, this has become possible.</div>
	</div>
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            ...
            <ol>
                <li>Request an invite to join the FEDU community (request invite button)</li>
                <li>Create a project and share it with your family, friends, peers, school and social media. Click here for FEDU’s “Best Practices & Recommendations” towards successfully funding a project</li>
