             ...
             <div class="col-xs-12 footer-mid-section footer-p-text-align">
				...
				<br>
		 		<div class="thomas-testimonial">
        	        ...
        	        in building support<br> for the Eagle Academy movement." <br><br><span>Thomas Owens</span><br><p class="egle">Eagle Academy</p>
        	  	</div>
      		...
      		<section class="row footer-lg-first-section">
        		...
        		<div class="col-md-4 footer-hands-image-top ">
      				<div class="footer-mid-section-img">
        	  			<br>
        	  			<img src="//s3.amazonaws.com/crowdera/assets/Hand-Image.png" alt="Crowdera">
        	  			<a href="#" class="display-footer-text"><img class="footer-start-cmpg-img" src="//s3.amazonaws.com/crowdera/assets/start-your-campaign-footer-button.png" alt="Crowdera"></a>
        	  		</div>
      			</div>
		        	...
		        	<div class="footer-newsletter">
        				<form action="//fedu.us3.list-manage.com/subscribe/post?u=41c633b30eeabc78e88bd090d&id=e37aea1b78" method="post" id="mc-embedded-subscribe-form-lg" name="mc-embedded-subscribe-form" class="validate" target="_blank">
							<div>
				    			...
				    			<div class="col-md-6 footer-signup-margin">
      	...
      	<section class="row">
      		<div class="col-md-8 footer-last-section-payment-icon">
      			<div class="col-md-6 payment-method-footer">
      				...
      				<img src="//s3.amazonaws.com/crowdera/assets/payment-icon-footer.png">
      			</div>
