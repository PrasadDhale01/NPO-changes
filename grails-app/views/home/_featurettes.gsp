...
<div class="row featurette">
  ...
  <div class="col-md-5">
    <img class="featurette-image img-responsive" src="http://placehold.it/500" alt="Create Project">
  </div>
</div>
...
<div class="row featurette">
  <div class="col-md-5">
    <img class="featurette-image img-responsive" src="http://placehold.it/500" alt="Fund Project">
  </div>
  <div class="col-md-7">
    <h2 class="featurette-heading">FUND PROJECT. <span class="text-muted">Connect Contribute & Repeat.</span></h2>
    <p class="lead">Select the project you feel connected, each beneficiary has their own needs. Perhaps one of them cannot afford to purchase required textbooks for their course. Another might not be able to finish paying his tuition for a semester. You can start improving life of the beneficiary with your first contribution. Whether it's finishing a project, course, or semester, you can see your selected project make progress little by little on this site, a reminder that your contribution has a significant effect. You & FEDU together can confront social inequality in education globally. You see the impact you have made on someone's life, you loved the rewards, now its turn to connect with another</p>
  </div>
</div>
