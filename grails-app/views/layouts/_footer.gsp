      ...
      <!-- --------------------------Section two------------------------- -->
       ...
       <!-- --------------------------Section three------------------------- -->
        <section class="row">
		    ...
		    <a href="http://crowdera.tumblr.com"  target="_blank"><img class="blogsocialicon" src="//s3.amazonaws.com/crowdera/assets/blogFooter.png" alt="twitter"></a>
		    <a href="https://www.facebook.com/crowderainc?ref=hl"  target="_blank"><img class="facebooklink" src="//s3.amazonaws.com/crowdera/assets/facebookFooter.png" alt="facebook"></a>
		    <a href="https://twitter.com/CrowderaInc"  target="_blank"><img class="twittersocialicon" src="//s3.amazonaws.com/crowdera/assets/twitterFooter.png" alt="twitter"></a>
		    <a href="https://www.linkedin.com/company/fedu"  target="_blank"><img class="inlink" src="//s3.amazonaws.com/crowdera/assets/linkedinFooter.png" alt="Linkedin"></a>
		    <a href="http://instagram.com/crowderacrew"  target="_blank"><img class="insta" src="//s3.amazonaws.com/crowdera/assets/instagramFooter.png" alt="Instagram"></a>
		</div>
		<br><br>
		 <div class="thomas-testimonial">
		    <p>"Through the Crowdera platform<br> our scholars, parents, families, staff and<br> parents can participate
        	        in building support for<br> the Eagle Academy movement." <br><br><b>Thomas Owens</b><br><p class="egle">Eagle Academy</p>
        	  </div>
...
<%--		          	    <li><a href="${resource(dir: '/campaigns/create')}">Create a Fundraiser</a></li>--%>
   	  	...
   	  	<br>
   	  	 <!-- -----------------Section Three-------------------- -->
   	  	<section class="row">
   	  		<div class="col-sm-6 col-sm-offset-3 footer-first-section">
        		  <p>Hands up for a Better World. See how you can make a difference with Crowdera.</p>
        	 	  <div class="footer-mid-section-img">
        	  		<img src="//s3.amazonaws.com/crowdera/assets/Hand-Image.png" alt="Crowdera">
        	  		<a href="${resource(dir: '/campaigns/create')}"><img src="//s3.amazonaws.com/crowdera/assets/start-a-campaign.png" alt="Crowdera"></a>
        	  	  </div>
   	  		</div>
   	  	</section>
   	  	 <!-- -----------------Section Four-------------------- -->
