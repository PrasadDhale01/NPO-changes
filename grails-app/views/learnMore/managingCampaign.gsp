...
<head>
    ...
    <title>Learn More- Managing Campaign</title>
</head>
<body>
<div class="feducontent learnBg-color">
   <div class="container learnContainer">
      <div class="row footer-panel-group" >
          <h1><strong class="faq-subheading"><a href="/Learning-Center">Learn More </a>> Managing a campaign</strong></h1>
             <hr>
             <div class="pull-left hidden-xs" >
             <ul id="side-menu" class="greyColor" style="height: 745px;" >
<li>
             ...
             <div class="pull-right col-lg-8 paneWidth" id="accordion">
              ...
              <div class="panel panel-default">
                ...
                <div class="panel panel-default">
                    <div class="panel-heading">
                        <h4 class="panel-title">
                            <a class="accordion-toggle collapsed" data-toggle="collapse" data-parent="#accordion" href="#collapsemanageSeven">Where do I access the contribution report?</a>
                        </h4>
                    </div>
