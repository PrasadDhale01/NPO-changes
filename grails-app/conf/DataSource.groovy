...
environments {
	development {
		dataSource {
			...
			dbCreate = "update"
			url = "jdbc:mysql://localhost:3306/crowderadb?zeroDateTimeBehavior=convertToNull"
	...
	staging {
		dataSource {
			...
			url = "jdbc:mysql://crowderadb-staging.c5qkqnx9x4ca.us-west-2.rds.amazonaws.com:3306/crowderadb?zeroDateTimeBehavior=convertToNull"
			driverClassName = "com.mysql.jdbc.Driver"
			dialect = "org.hibernate.dialect.MySQL5InnoDBDialect"
