<div class="container">
	<h1>FAQ</h1>
	<h3>What is FEDU?</h3>
	<p class="text-justify">FEDU is a global platform that identifies
		...
		to receiving education. FEDU means mobilizing our collective resources
		to connect those with unequal access to the educational needs that
		will directly impact their quality of life.</p>

	<h3>What makes FEDU different from other crowdfunding platforms?</h3>
	...
	<h3>What kinds of projects does FEDU fund?</h3>
	<p class="text-justify">FEDU believes that education means
		...
		In order to best enable education for all, FEDU funds needs that: 1)
	...
	<h3>How does FEDU identify and qualify students?</h3>
	<p class="text-justify">Our process always begins with human
		...
		process and are screened by either FEDU or a trusted partner. While we
	...
	<p class="text-justify">No. While we support charity via
		...
		sustainable. FEDU has grown out of the rising belief that social
		enterprises can serve as impactful hybrid models for mission-driven
		entities.</p>

	<h3>What is FEDU's business model?</h3>
	...
	<p class="text-justify">To ensure that funds are used for
		educational needs, FEDU will never disburse directly to the
	...
	<p class="text-justify">FEDU provides a gratifying opportunity for
