...
<head>
    ...
    <title>Learn More- Contributor</title>
</head>
<body>
<div class="feducontent learnBg-color">
   <div class="container learnContainer">
   <div class="row footer-panel-group">
          <h1><strong class="faq-subheading"><a href="${resource(dir: '/Learning-Center')}">Learn More </a>> Contributor</strong></h1>
           <hr> 
             <div class="pull-left hidden-xs">
   <ul id="side-menu" class="greyColor"  style="height: 622px;" >
<li>
