...
<g:else>
   ...
   <br><br>
      ...
      <div class="row rowTwo">
         <div class="col-lg-3">
            <img class="img-responsive imageFour" src="//s3.amazonaws.com/crowdera/project-images/dca74e85-6b35-4a30-adec-214c11c91267.jpg" title="Sucessfull-Campaign-Image--4(1).png">
         </div>
         <div class="col-lg-6">
      ...
      <div class="row rowThree">
         <div class="col-lg-6 innerCollage">
            ...
            <div class="row innerrowTwo">
                     <img class="img-responsive pull-left imageSeven" src="//s3.amazonaws.com/crowdera/project-images/a982f0c0-c907-4e76-ad3d-c0933a0f3c0e.jpg" title="Sucessfull-Campaign-Image--8.png">
                     <img class="img-responsive pull-right imageEight" src="//s3.amazonaws.com/crowdera/project-images/026767a4-ddec-4099-b2c1-7f103fc65866.jpg" title="Sucessfull-Campaign-Image--9.png">
               </div>
         </div>
         <div class="col-lg-3">
      ...
      <br>
      <b class="successfullcampaignBottomline">and many more partners rely on free crowdera for thier fundraising needs</b>
   </div>   
   </div>
</g:else>