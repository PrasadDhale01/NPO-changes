...
<div class="how-it-on-image">
    ...
    <div class="sso">
        <div class="container how-it-thousands">
            <div class="text-center hiw-tips-for">
                <h2>TIPS FOR SUCCESS</h2>
            </div>
            <div class="hiw-dis-title">
                <div class="row">
                    <div class=" how-it-discriptionsall col-lg-3 col-sm-3 col-md-3 col-xs-12">
                        <div class="how-circle">
                            <h4 class="text-center how-title">
                                <span>Set Your Funding Goal</span>
                            </h4>
                            <h6 class="how-des-1">
                                Decide how much you’d like to raise for your cause and how long to
                                run your campaign. We suggest your campaign to be at least 30 days,
                    ...
                    <div class="how-it-one col-lg-3 col-sm-3 col-md-3 col-xs-12">
                    ...
                    <div class="how-it-two col-lg-3 col-sm-3 col-md-3 col-xs-12">
                        <h4>
...
<%--    <div class="row how-it-on-image">--%>
<%--        <section>--%>
<%--            <div class="how-it-content">--%>
<%--            --%>
<%--            </div>--%>
<%--            <div class="how-it-img">--%>
<%--                <div class="how-ittt"></div>--%>
<%--            </div>--%>
<%--        --%>
<%--        </section>--%>
<%--    </div>--%>
